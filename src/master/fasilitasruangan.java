...
public int jumlahsteker;
public int kondisisteker;
public int posisisteker;
public int jumlahkabellcd;
public int kondisikabellcd;
public int posisikabellcd;
public int jumlahlampu;
public int kondisilampu;
public int posisilampu;
public int jumlahkipasangin;
public int kondisikipasangin;
public int posisikipasangin;
public int jumlahac;
public int kondisiac;
public int posisiac;
public double banwidth;
...
public int login;
    ...
    public void setBanwidth(double banwidth) {
...
void fasilitasruangan1(String SSID,int login){
this.SSID=SSID;
this.login=login;
}
void faslitasruangan1(String SSID,int login,double bandwith){
    this.SSID=SSID;
    this.login=login;
    this.banwidth=banwidth;
}
